...
def send_email(uip, cutoff, user_email):
    ...
    download_path = os.path.join(WORK_FOLD, 'static/resulthmmer/' + uip + '.txt')
    ...
    if user_email != '':
        ...
        body +=    '<p>Dear user,<br /><br />'+ \
                   'Attached please find the results generated by SMI-BLAST web-server. You can also access the results by clicking <a href="http://bliulab.net/SMI-BLAST/resulthmmer/'+ uip+ '?cutoff=' + str(cutoff)+ '"><font color="#123456"><b>Results</b><font></a><br /><br />'+ \
                   'Thank you for using SMI-HMMER !<br /><br />'+ \
...
if __name__ == '__main__':
    ...
    uip = sys.argv[3]
    user_dir = os.path.join(USER_FOLD, uip)
    res = methods.extract_resultshmmer(user_dir, cutoff)
    download_path = os.path.join(WORK_FOLD, 'static/resulthmmer/' + uip + '.txt')
